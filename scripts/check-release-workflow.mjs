...
requireText("node-version-file: soksak-plugins/soksak-plugin-terminal-kitty/.node-version", "Node owner");
requireText("package_json_file: soksak-plugins/soksak-plugin-terminal-kitty/frontend/package.json", "pnpm owner");
